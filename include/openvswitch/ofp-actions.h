...
#define OFPACTS                                                         \
    ...
    OFPACT(VIRO_PUSH_FD,           ofpact_viro_push_fd,       ofpact, "viro_push_fd") \
    OFPACT(VIRO_POP_FD,            ofpact_null,               ofpact, "viro_pop_fd") \
    OFPACT(VIRO_SET_VID_SW_FD,     ofpact_viro_set_vid_sw,    ofpact, "viro_set_vid_sw_fd") \
    OFPACT(VIRO_SET_VID_SW_SRC,    ofpact_viro_set_vid_sw,    ofpact, "viro_set_vid_sw_src") \
    OFPACT(VIRO_SET_VID_SW_DST,    ofpact_viro_set_vid_sw,    ofpact, "viro_set_vid_sw_dst") \
    OFPACT(VIRO_SET_VID_HOST_FD,   ofpact_viro_set_vid_host,  ofpact, "viro_set_vid_host_fd") \
    OFPACT(VIRO_SET_VID_HOST_SRC,  ofpact_viro_set_vid_host,  ofpact, "viro_set_vid_host_src") \
    OFPACT(VIRO_SET_VID_HOST_DST,  ofpact_viro_set_vid_host,  ofpact, "viro_set_vid_host_dst")
...
/* VIRO extensions */
struct ofpact_viro_push_fd {
    struct ofpact ofpact;
    ovs_be16 fd_host;
    ovs_be32 fd_sw;
};

struct ofpact_viro_set_vid_sw {
    struct ofpact ofpact;
    ovs_be32 sw;
};

struct ofpact_viro_set_vid_host {
    struct ofpact ofpact;
    ovs_be16 host;
};
