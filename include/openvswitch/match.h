...
void match_set_viro_dst_sw(struct match *, ovs_be32);
void match_set_viro_dst_sw_masked(struct match *, ovs_be32, ovs_be32);
void match_set_viro_src_sw(struct match *, ovs_be32);
void match_set_viro_src_sw_masked(struct match *, ovs_be32, ovs_be32);
void match_set_viro_fd_sw(struct match *, ovs_be32);
void match_set_viro_fd_sw_masked(struct match *, ovs_be32, ovs_be32);
void match_set_viro_dst_host(struct match *, ovs_be16);
void match_set_viro_src_host(struct match *, ovs_be16);
void match_set_viro_fd_host(struct match *, ovs_be16);

/* Compressed match. */
