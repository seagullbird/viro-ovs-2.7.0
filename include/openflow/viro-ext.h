 ...
 */
#define NXM_VIRO_DST_SW       NXM_HEADER(0x0002, 0x0000, 1, 0, 4)
#define NXM_VIRO_DST_SW_W     NXM_HEADER(0x0002, 0x0000, 1, 1, 8)
#define NXM_VIRO_DST_HOST     NXM_HEADER(0x0002, 0x0000, 2, 0, 2)
#define NXM_VIRO_SRC_SW       NXM_HEADER(0x0002, 0x0000, 3, 0, 4)
#define NXM_VIRO_SRC_SW_W     NXM_HEADER(0x0002, 0x0000, 3, 1, 8)
#define NXM_VIRO_SRC_HOST     NXM_HEADER(0x0002, 0x0000, 4, 0, 2)
#define NXM_VIRO_FD_SW        NXM_HEADER(0x0002, 0x0000, 5, 0, 4)
#define NXM_VIRO_FD_SW_W      NXM_HEADER(0x0002, 0x0000, 5, 1, 8)
#define NXM_VIRO_FD_HOST      NXM_HEADER(0x0002, 0x0000, 6, 0, 2)
